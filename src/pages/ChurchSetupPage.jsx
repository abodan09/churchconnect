...
export default function ChurchSetupPage() {
  ...
  async function handleFinish() {
    ...
    setError("");
    try {
      // The church creator is always super_admin (enforced server-side in
      // api/churches/register.js / the local setup endpoint). Role assignment for
      // everyone else happens in the admin Users & Roles page — never here.
